...
function FirstSevenNft({
  ...
  // console.log(loadingOnChangeCat);
  return (
    <>
        ...
        >
          ...
          <TableBody>
            {loadingOnChangeCat ? (
              ...
              categoryFirstData ? (
                categoryFirstData.map((row) => (
                  <StyleTableRow
                    // onClick={tableRowHref}
                    // role="checkbox"
