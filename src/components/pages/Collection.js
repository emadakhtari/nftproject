...
// .css-1bgjj9k-MuiFormLabel-root.Mui-focused
    ...
    const getItems = async (page) => {
      ...
      try {
        ...
        await axios
          ...
          .then((resp) => {
            setCollectionItems(resp.data.result.CollectionPage);
        ...
        >
          <StyleToolbar>
            ...
            <StyleCollectionsTitle>
              {loading ? (
                <Typography variant="h6">{collectionItems.title}</Typography>
              ) : (
                <Skeleton width="30%">
